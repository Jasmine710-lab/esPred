# Adapted from https://github.com/qyyin0516/CellTICS/blob/main/code/pathway_hierarchy.py
import numpy as np
import pandas as pd
...
def get_masking(pathway_names, pathway_genes, relations_file_name, adata, species='mouse', n_hidden=5):
    ...
    genes_df = gene_mapping(adata.var_names.tolist(), genes_df)
    ...
    layers_node[0] = list(set(adata.obs["outcome"]))
